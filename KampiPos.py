...
nollasivu_otsikko = ("OSALLISTU TIETEELLISEEN \n TUTKIMUKSEEN")
...
tokasivu_teksti3_otsikko = ("Olet ansainnut Unisefille:")
...
def paivita_tokasivu():
    ...
    ansaittu2 = (nyt - tokasivu_kaynnistetty) * euroaPerTunti2/3600
    ansaittu_teksti2 = '{0:.2f}'.format(ansaittu2) + ' €'
    tokasivu_teksti2.configure(text=ansaittu_teksti)
    tokasivu_teksti2.pack()
    tokasivu_teksti4.configure(text=ansaittu_teksti2)
    tokasivu_teksti4.pack()
...
def kiitossivu_paalle():
    ...
    output_teksti = (testiNimi + " "+ aikaleima + " " + '{0:.2f}'.format(ansaittu) + " " + '{0:.2f}'.format(ansaittu2) + " " + str(arvosana1) + str(arvosana2) + '\n')
...
tokasivu_teksti3 = tk.Label(tokasivu, text=tokasivu_teksti3_otsikko,bg=taustavari,fg=tekstivari,font=isofontti)
tokasivu_teksti3.pack(side=TOP)
